...
namespace Microsoft.PWABuilder.Oculus
{
    ...
    public class WebAppManifest
    {
        ...
        /// <summary>
        /// Oculus proprietary extension to enable multiple tabs inside a PWA.
        /// </summary>
        [JsonPropertyName("ovr_multi_tab_enabled")]
        public string? OculusMultiTabEnabled { get; set; }

        /// <summary>
        /// Oculus proprietary extension to enable the PWA to have mutiple domain scopes.
        /// </summary>
        [JsonPropertyName("ovr_scope_extensions")]
        public List<OculusScopeExtension>? OculusScopeExtensions { get; set; }
    ...
    public class OculusScopeExtension
    {
