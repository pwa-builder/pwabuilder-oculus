...
namespace Microsoft.PWABuilder.Oculus.Services
{
    ...
    public class ProcessRunner
    {
        ...
        public ProcessRunner(
            ZombieProcessKiller procKiller, 
        ...
        private static ProcessException CreateCliError(
            string message, 
            ...
            string processArgs)
        {
            var formattedMessage = string.Join(Environment.NewLine + Environment.NewLine, message, $"Process: {processPath}", $"Process args: {processArgs}", $"Standard output: {standardOutput}", $"Standard error: {standardErrorOutput}");
